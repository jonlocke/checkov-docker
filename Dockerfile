...
RUN apk update && apk add bash curl python3 py-six git tzdata py3-natsort py3-ldap3 py3-xlsxwriter py3-requests jq py3-pip py3-wheel py3-cffi python3-dev py3-setuptools gcc py3-cryptography openssh-client caddy nss-tools sed go musl-dev linux-headers
